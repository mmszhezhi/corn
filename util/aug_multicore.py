...
def gen_batches(files,scale_bs=10,aug_bs=5, crop_size=600,scale=4):
    ...
    for xml_file in files:
        ...
        try:
            ...
            batche = UnnormalizedBatch(images=imgs, bounding_boxes=[bbss for bbss in  bbs_scale for _ in range(aug_bs)])
...
if __name__ == '__main__':
    ...
    td = f"a0-{scale_bs}-{aug_bs}-{crop_size}"
    os.chdir(os.getcwd())
